...
public class ImageUtils {
    ...
    public static String processImageUrl(final Context context, final String artistName,
        ...
        switch (imageType) {
            case ARTIST:
                if ((!TextUtils.isEmpty(artistName)) && (context.getResources().getBoolean(R.bool.is_noncommercial))) {
                ...
                break;
            case ALBUM:
                if ((!TextUtils.isEmpty(artistName) && !TextUtils.isEmpty(albumName)) && (context.getResources().getBoolean(R.bool.is_noncommercial))) {
    ...
    private static String getBestImage(MusicEntry e) {
        final ImageSize[] QUALITY = {ImageSize.MEGA, ImageSize.EXTRALARGE, ImageSize.LARGE, ImageSize.MEDIUM,
