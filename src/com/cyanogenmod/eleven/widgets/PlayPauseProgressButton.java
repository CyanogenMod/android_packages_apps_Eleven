...
public class PlayPauseProgressButton extends FrameLayout {
    ...
    public PlayPauseProgressButton(Context context, AttributeSet attrs) {
        ...
        mSmallDistance = context.getResources().getDimensionPixelSize(R.dimen.small_move_distance);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        boolean retValue = onTouchEvent(ev);
        Log.d("Linus", "Returning: " + retValue);
        return retValue;
    }
    ...
    /**
     * Gets the change in angle since down has been pressed
     */
