...
public class SettingsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener{
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
        ...
        if (key.equals(PreferenceUtils.SHAKE_TO_PLAY)) {
            MusicUtils.setShakeToPlayEnabled(this,sharedPreferences.getBoolean(key, false));
        } else if (key.equals(PreferenceUtils.SHOW_ALBUM_ART_ON_LOCKSCREEN)) {
            MusicUtils.setShowAlbumArtOnLockscreen(this,sharedPreferences.getBoolean(key, true));
        }
    }
}
