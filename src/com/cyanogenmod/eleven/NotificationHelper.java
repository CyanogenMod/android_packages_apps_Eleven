...
public class NotificationHelper {
    ...
    public void updatePlayState(final boolean isPlaying) {
        ...
        if (mNotificationTemplate != null) {
            mNotificationTemplate.setImageViewResource(R.id.notification_base_play,
                    isPlaying ? R.drawable.btn_playback_pause : R.drawable.btn_playback_pause_white);
        }
    ...
    private PendingIntent getPendingIntent() {
        return PendingIntent.getActivity(mService, 0, new Intent("com.cyanogenmod.eleven.AUDIO_PLAYER")
